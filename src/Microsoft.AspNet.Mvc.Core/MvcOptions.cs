...
namespace Microsoft.AspNet.Mvc
{
    ...
    public class MvcOptions
    {
        ...
        /// <summary>
        /// Gets a <see cref="IList{IModelBinder}"/>s used by this application.
        /// </summary>
        public IList<IModelBinder> ModelBinders { get; }

        /// <summary>
        /// Gets a <see cref="IList{IModelValidatorProvider}"/>s used by this application.
        /// </summary>
        ...
        /// <summary>
        /// Gets a <see cref="IList{IValueProviderFactory}"/> used by this application.
        /// </summary>
        public IList<IValueProviderFactory> ValueProviderFactories { get; }

        /// <summary>
        /// Gets a <see cref="IList{IApplicationModelConvention}"/> instances that will be applied to
        ...
        /// <summary>
        /// Gets a <see cref="IList{IMetadataDetailsProvider}"/> instances that will be used to 
